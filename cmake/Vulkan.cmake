function(target_link_vulkan target_name INCLUDE_TYPE)
    ...
    if (${PROJECT_PREFIX}_BUILD_SHARED AND WIN32)
        ...
        target_link_libraries(${target_name} ${INCLUDE_TYPE} spirv-cross-c-shared)
    else ()
        ...
        target_link_libraries(${target_name} ${INCLUDE_TYPE} spirv-cross-cpp)
    endif ()
    ...
    target_link_libraries(${target_name} ${INCLUDE_TYPE} shaderc::shaderc_shared)
