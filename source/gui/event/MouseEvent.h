...
public:
	 ...
	 */
	[[nodiscard]] auto getMouseButton() const -> MouseCode { return m_mouseButton; }
...
protected:
	 ...
	 */
	explicit MouseButtonEvent(const MouseCode iXOffset) : m_mouseButton(iXOffset) {}
...
public:
	 ...
	 */
	explicit MouseButtonPressedEvent(const MouseCode iButton) : MouseButtonEvent(iButton) {}
...
public:
	 ...
	 * @param[in] iButton The mouse button.
	 */
	explicit MouseButtonReleasedEvent(const MouseCode iButton) : MouseButtonEvent(iButton) {}
