...
TEST(carton, activation) {
    evl::core::Carton carton1;
    EXPECT_TRUE(carton1.isActive());
    EXPECT_EQ(carton1.getStatus(), evl::core::Carton::ResultCarton::EnCours);
    carton1.deactivate();
...
TEST(carton, play) {
    ...
    EXPECT_EQ(carton1.getStatus(), evl::core::Carton::ResultCarton::PresqueUneLigne);
    carton1.playNumber(1);
    EXPECT_EQ(carton1.getStatus(), evl::core::Carton::ResultCarton::UneLigne);
    for(uint8_t i: {4, 23, 12, 85, 47, 69, 78})
        carton1.playNumber(i);
    EXPECT_EQ(carton1.getStatus(), evl::core::Carton::ResultCarton::PresqueDeuxLignes);
    carton1.playNumber(36);
    EXPECT_EQ(carton1.getStatus(), evl::core::Carton::ResultCarton::DeuxLignes);
    carton1.playNumber(24);
    EXPECT_EQ(carton1.getStatus(), evl::core::Carton::ResultCarton::PresqueCartonPlein);
    carton1.playNumber(31);
    EXPECT_EQ(carton1.getStatus(), evl::core::Carton::ResultCarton::CartonPlein);
