...
TEST(gui_event, KeyEvents) {
	...
	EXPECT_EQ(keyPressEvent.getCategoryFlags(), evl::gui::event::Category::Keyboard | evl::gui::event::Category::Input);
	...
	EXPECT_EQ(keyTypedEvent.getCategoryFlags(), evl::gui::event::Category::Keyboard | evl::gui::event::Category::Input);
}
...
TEST(gui_event, MouseEvents) {
	...
	EXPECT_EQ(mouseMoveEvent.getCategoryFlags(), evl::gui::event::Category::Mouse | evl::gui::event::Category::Input);
	...
	EXPECT_EQ(mouseScrollEvent.getCategoryFlags(), evl::gui::event::Category::Mouse | evl::gui::event::Category::Input);
	...
	EXPECT_EQ(mouseButtonPressEvent.getCategoryFlags(), evl::gui::event::Category::Mouse |
																evl::gui::event::Category::Input |
																evl::gui::event::Category::MouseButton);
	...
	EXPECT_EQ(mouseButtonReleaseEvent.getCategoryFlags(), evl::gui::event::Category::Mouse |
																  evl::gui::event::Category::Input |
																  evl::gui::event::Category::MouseButton);
}
...
TEST(gui_event, EventDispatcher) {
	...
	dispatched = dispatcher3.dispatch<evl::gui::event::KeyPressedEvent>([](evl::gui::event::KeyPressedEvent&) -> bool {
...
TEST(KeyCode, FormatVoidKey) { EXPECT_STREQ(std::format("{}", evl::gui::KeyCode::Void).c_str(), ""); }
